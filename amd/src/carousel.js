  ...
  var Carousel = (function() {
    ...
    _createClass(Carousel, [{
      ...
      value: function nextWhenVisible() {
        ...
        if (!document.hidden && (0, _jquery2.default)(this._element).is(':visible')
            && (0, _jquery2.default)(this._element).css('visibility') !== 'hidden') {
          this.next();
        }
      }
    }, {
      ...
      value: function _slide(direction, element) {
        ...
        if ((0, _jquery2.default)(this._element).hasClass(ClassName.SLIDE)) {
          ...
          (0, _jquery2.default)(activeElement).one(_util2.default.TRANSITION_END, function() {
            (0, _jquery2.default)(nextElement).removeClass("".concat(directionalClassName, " ")
                .concat(orderClassName)).addClass(ClassName.ACTIVE);
            (0, _jquery2.default)(activeElement).removeClass("".concat(ClassName.ACTIVE, " ")
                .concat(orderClassName, " ").concat(directionalClassName));
