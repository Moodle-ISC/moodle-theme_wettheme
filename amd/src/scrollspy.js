 ...
 _defineProperties(Constructor, staticProps);
  ...
  var ScrollSpy = (function() {
    function ScrollSpy(element, config) {
      ...
      this._selector = "".concat(this._config.target, " ").concat(Selector.NAV_LINKS, ",")
          + "".concat(this._config.target, " ").concat(Selector.LIST_ITEMS, ",")
          + "".concat(this._config.target, " ").concat(Selector.DROPDOWN_ITEMS);
      this._offsets = [];
      this._targets = [];
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function _process() {
        ...
        for (var i = offsetLength; i--;) {
          var isActiveTarget = this._activeTarget !== this._targets[i] && scrollTop
              >= this._offsets[i] && (typeof this._offsets[i + 1] === 'undefined' || scrollTop < this._offsets[i + 1]);
      ...
      value: function _activate(target) {
        ...
        if ($link.hasClass(ClassName.DROPDOWN_ITEM)) {
          ...
          $link.parents(Selector.NAV_LIST_GROUP).prev("".concat(Selector.NAV_LINKS, ", ")
              .concat(Selector.LIST_ITEMS)).addClass(ClassName.ACTIVE); // Handle special case when .nav-link is inside .nav-item
