...
define(['jquery', './tether', 'core/event', 'core/custom_interaction_events'], function(jQuery, Tether, Event, customEvents) {
    ...
    M.util.js_pending('theme_wettheme/loader:children');

    require(['theme_wettheme/aria',
            'theme_wettheme/pending',
            'theme_wettheme/util',
            'theme_wettheme/alert',
            'theme_wettheme/button',
            'theme_wettheme/carousel',
            'theme_wettheme/collapse',
            'theme_wettheme/dropdown',
            'theme_wettheme/modal',
            'theme_wettheme/scrollspy',
            'theme_wettheme/tab',
            'theme_wettheme/tooltip',
            'theme_wettheme/popover'],
            function(Aria) {
        ...
        Aria.init();
        M.util.js_complete('theme_wettheme/loader:children');
    });
