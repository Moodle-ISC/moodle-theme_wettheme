...
define(["exports", "jquery", "./util"], function(exports, _jquery, _util) {
 ...
 _defineProperties(Constructor, staticProps);
    ...
    _createClass(Modal, [{
      ...
      value: function _showElement(relatedTarget) {
        ...
        if (transition) {
          ...
          (0, _jquery2.default)(this._dialog).one(_util2.default.TRANSITION_END, transitionComplete)
              .emulateTransitionEnd(transitionDuration);
        } else {
          transitionComplete();
        }
      ...
      value: function _enforceFocus() {
        ...
        .on(Event.FOCUSIN, function(event) {
          if (document !== event.target && _this4._element !== event.target && (0, _jquery2.default)(_this4._element)
      ...
      value: function _showBackdrop(callback) {
        ...
        if (this._isShown && this._config.backdrop) {
          ...
          (0, _jquery2.default)(this._backdrop).one(_util2.default.TRANSITION_END, callback)
          ...
          if ((0, _jquery2.default)(this._element).hasClass(ClassName.FADE)) {
            ...
            (0, _jquery2.default)(this._backdrop).one(_util2.default.TRANSITION_END, callbackRemove)
      ...
      value: function _setScrollbar() {
        ...
        if (this._isBodyOverflowing) {
          ...
          (0, _jquery2.default)(fixedContent).each(function(index, element) {
            ...
            (0, _jquery2.default)(element).data('padding-right', actualPadding)
                .css('padding-right', "".concat(parseFloat(calculatedPadding) + _this9._scrollbarWidth, "px"));
          ...
          (0, _jquery2.default)(stickyContent).each(function(index, element) {
            ...
            (0, _jquery2.default)(element).data('margin-right', actualMargin).css('margin-right', ""
                .concat(parseFloat(calculatedMargin) - _this9._scrollbarWidth, "px"));
          }); // Adjust body padding

          var actualPadding = document.body.style.paddingRight;
          var calculatedPadding = (0, _jquery2.default)(document.body).css('padding-right');
          (0, _jquery2.default)(document.body).data('padding-right', actualPadding).css('padding-right', ""
              .concat(parseFloat(calculatedPadding) + this._scrollbarWidth, "px"));
        }
  ...
  (0, _jquery2.default)(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function(event) {
    ...
    var config = (0, _jquery2.default)(target).data(DATA_KEY) ? 'toggle'
        : _objectSpread({}, (0, _jquery2.default)(target).data(), (0, _jquery2.default)(this).data());
